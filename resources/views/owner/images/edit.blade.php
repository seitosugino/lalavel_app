                  ...
                  <form method="post" action="{{ route('owner.images.update', ['image' => $image->id]) }}" >
                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 flex justify-around w-full mt-4">
                          <button type="button" onclick="location.href='{{ route('owner.images.index')}}'" class="flex mx-auto bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
