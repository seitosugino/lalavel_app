              ...
              <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <form method="post" action="{{ route('owner.products.update', ['product' => $product->id]) }}">
                    ...
                    <div class="-m-2">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative">
                          <label for="crrent_quantity" class="leading-7 text-sm text-gray-600">現在の在庫　※必須</label>
                      ...
                      <x-select-image :images="$images" currentId="{{ $product->image2 }}" currentSecond="{{ $product->imageFirst->filename ?? '' }}" name="image2" />
                      <x-select-image :images="$images" currentId="{{ $product->image3 }}" currentThird="{{ $product->imageFirst->filename ?? '' }}" name="image3" />
                      <x-select-image :images="$images" currentId="{{ $product->image4 }}" currentFourth="{{ $product->imageFirst->filename ?? '' }}" name="image4" />
                      ...
                      <div class="p-2 flex justify-around w-full mt-4">
                          <button type="button" onclick="location.href='{{ route('owner.products.index')}}'" class="flex mx-auto bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">戻る</button>
